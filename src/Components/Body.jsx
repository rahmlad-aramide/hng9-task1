...
const Body = () => {
  return (
    <div className='flex flex-col justify-center mt-8'>
        ...
        <div className='text-center bg-[#EAECF0] text-[#101828] font-Inter font-medium text-lg py-6 mx-4 md:mx-[9rem] mb-6' id='btn__zuri'><a target='_blank' rel="noreferrer" href='https://training.zuri.team'>Zuri Team</a></div>
        <div className='text-center bg-[#EAECF0] text-[#101828] font-Inter font-medium text-lg py-6 mx-4 md:mx-[9rem] mb-6' id='books'><a target='_blank' rel="noreferrer" href='https://books.zuri.team'>Zuri Books</a></div>
        ...
        <div className='text-center bg-[#EAECF0] text-[#101828] font-Inter font-medium text-lg py-6 mx-4 md:mx-[9rem] mb-6' id='pitch'><a target='_blank' rel="noreferrer" href='https://background.zuri.team'>Background Check for Coders</a></div>
        <div className='text-center bg-[#EAECF0] text-[#101828] font-Inter font-medium text-lg py-6 mx-4 md:mx-[9rem]' id='book__design'><a target='_blank' rel="noreferrer" href='https://books.zuri.team/design-rules'>Design Books</a></div>
