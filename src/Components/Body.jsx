...
const Body = () => {
  return (
    <div className='flex flex-col justify-center mt-8'>
        ...
        <div className='text-center bg-[#EAECF0] text-[#101828] font-Inter font-medium text-lg py-6 mx-4 md:mx-[9rem] mb-6' id='pitch'><a target='_blank' rel="noreferrer" href='background.zuri.team'>Background Check for Coders</a></div>
        <div className='text-center bg-[#EAECF0] text-[#101828] font-Inter font-medium text-lg py-6 mx-4 md:mx-[9rem]' id='book__design'><a target='_blank' rel="noreferrer" href='books.zuri.team/design-rules'>Design Books</a></div>
